...
import java.bank.br.com.dio.exception.AccountNotFoundException;
...
import main.java.java.bank.br.com.dio.exception.PixInUseException;
...
public class AccountRepository {
    ...
    public Map<OffsetDateTime, List<MoneyAudit>> getHistory(final String pix){
        ...
        return audit.stream()
        .collect(Collectors.groupingBy(t -> t.createAt().truncatedTo(ChronoUnit.SECONDS)));
    }
